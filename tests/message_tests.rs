...
fn test_message_integration() {
    ...
    let expected_ai_msg_debug = r#"AiMessage { base: BaseMessageFields { content: "This is an AI response", example: false, additional_kwargs: {}, response_metadata: {}, id: None, name: None } }"#;
    ...
    let expected_human_msg_debug = r#"HumanMessage { base: BaseMessageFields { content: "This is a human message", example: false, additional_kwargs: {}, response_metadata: {}, id: None, name: None } }"#;
    ...
    let expected_system_msg_debug = r#"SystemMessage { base: BaseMessageFields { content: "System message content", example: false, additional_kwargs: {}, response_metadata: {}, id: None, name: None } }"#;
